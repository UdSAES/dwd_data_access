...
describe('Verify behaviour of API-instance against OAS and/or expectations', function () {
  ...
  const apiInstance = got.extend({
    ...
    timeout: 20000 // https://www.npmjs.com/package/got#timeout
  })
  ...
  tests.forEach(function (test) {
    let testTitle = `GET /weather-stations/${test.stationId}/forecast`
    let concatSymbol = '?'
    ...
    describe(testTitle, function () {
      const options = {
        ...
        url: `weather-stations/${test.stationId}/forecast`,
        searchParams: {}
      }
      if (!_.isNil(test.quantities)) {

...
function renderTimeseriesAsCSV (voiConfigs, timeseriesDataCollection) {
  const csvLabels = getCSVLabels(voiConfigs, timeseriesDataCollection)
  const formatted = {}
  _.forEach(timeseriesDataCollection, function (element) {
